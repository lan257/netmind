...
MIND_MAP_CASCADE_DELETE_ENDPOINT = "/api/mind-maps/{id}/cascade"
DEFAULT_TIMEOUT_SECONDS = 10

def run(params: dict[str, Any]) -> dict[str, Any]:
    """删除导图并级联删除相关节点与关系。

    调用后端 DELETE /api/mind-maps/{id}/cascade 接口，返回 DeleteResultDto。
    """
    ...
    endpoint = MIND_MAP_CASCADE_DELETE_ENDPOINT.replace("{id}", str(mind_map_id))
