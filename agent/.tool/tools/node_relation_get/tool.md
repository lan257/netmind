# node_relation_get - 查询单个关系

## 功能说明

按ID查询节点关系，调用后端 `GET /api/node-relations/{id}` 接口。
...
```json
{
  ...
  "message": "成功",
  "status_code": 200,
  "endpoint": "/api/node-relations/42",
  "id": 42,
  "relation": {
    "id": 42,
    "sourceId": 10,
...
| `id` | long | 查询的关系 ID |
| `relation` | object/null | 节点关系对象（NodeRelationDto），失败时为 null |
