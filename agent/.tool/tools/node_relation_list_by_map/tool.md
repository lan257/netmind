# node_relation_list_by_map - 查询导图下关系

## 功能说明

查询某个导图下的所有节点关系，调用后端 `GET /api/node-relations/by-map/{mapId}` 接口。
...
```json
{
  ...
  "message": "成功",
  "status_code": 200,
  "endpoint": "/api/node-relations/by-map/42",
  "mapId": 42,
  "relations": [
    {
      "id": 1,
